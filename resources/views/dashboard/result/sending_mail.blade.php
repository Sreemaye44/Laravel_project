    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default w3-hover-shadow" style="font-family: optima">
                <div class="panel-heading w3-blue"><h2>Email Results</h2></div>
                <div>
                ...
                <table class="w3-table w3-striped w3-border w3-bordered w3-card-4 w3-accordion w3-large" id="myTable">
                  ...
                  @foreach($exams as $exam)
                    <tr>
                        ...
                        <td>{{ $exam->year }}</td>
                        <td>{{ $exam->semester }}</td>
                        <td>{{ $exam->examination }}<a href="{{ route('mail.result', ['year' => $exam->year, 'semester' => $exam->semester, 'examination' => $exam->examination, 'department' => $department]) }}" class="w3-right btn btn-primary">Send&emsp;<span class="fa fa-envelope"</a></td>
                    </tr>
                    <?php $count = $count + 1;?>
                  @endforeach
                  </tbody>
