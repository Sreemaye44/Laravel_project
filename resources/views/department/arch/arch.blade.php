...
<div class="container">
    <div class="row">
        <div class="col-lg-2 col-md-2 col-sm-6 col-xs-6">
            <ul class="w3-ul w3-border w3-bordered">
                ...
                <li class="w3-hover-shadow">
                    <a href="{{ route('arch.student') }}" class="w3-text-black btn">Current Students</a>
                </li>
                <li class="w3-hover-shadow">
                    <a href="{{ route('get.materials', ['filename' => 'Syllabus-ARCH.pdf']) }}" target="_blank" class="w3-text-black btn">Syllabus</a>
                </li>
                <li class="w3-hover-shadow">
                    <a href="{{ route('get.materials', ['filename' => 'Routine-ARCH.pdf']) }}" target="_blank" class="w3-text-black btn">Class Routine</a>
                </li>
                <li class="w3-hover-shadow">
                    <a href="{{ route('exam.list', ['department' => 'ARCH']) }}" target="_blank" class="w3-text-black btn">Semester Result</a>
                </li>
                <li class="w3-hover-shadow">
                    <a href="{{ route('get.materials', ['filename' => 'CourseRegistration-ARCH.pdf']) }}" target="_blank" class="w3-text-black btn">Course Registration</a>
                </li>
                <li class="w3-hover-shadow">
                    <a href="{{ route('get.materials', ['filename' => 'FormFillUp-ARCH.pdf']) }}" target="_blank" class="w3-text-black btn">Exam Form Fill Up</a>
                </li>
            </ul>
        </div>
        ...
        <div class="col-lg-2 col-md-2 col-sm-6 col-xs-6 w3-right">
            <ul class="w3-ul w3-border w3-bordered">
                <li class="w3-indigo w3-xlarge w3-center">ARCH RUET</li>
                <li class="w3-hover-shadow"><a href="#about" class="w3-text-black btn">About ARCH RUET</a></li>
    ...
    <div class="row">
        <div class="col-md-7">
            <div id="about" class="panel panel-default w3-hover-shadow">
                <div class="panel-heading w3-blue row"><h3>About ARCH RUET</h3></div>
                <div class="panel-body w3-light-grey row"  style="height: 200px; text-align: justify;">
                    <p class="w3-large" style="font-family: optima">
                        Department of architecture in RUET started its journey in 2013. 
                        Architecture involves the study and transformation of the constructed environment, 
                        from the scale of furniture to the scale of the city. 
                        The goal of this new discipline is to equip the student 
                        with skill to develop a synthetic thought process of critical thinking 
                        and creative problem solving to address all aspects of the built environment 
                        in its cultural, social, and ethical context and to meet 
                        the challenge of this new millennium.
                    </p>
        ...
        <div class="col-md-4 col-md-offset-1">
            <div class="panel panel-default w3-hover-shadow">
                <div class="panel-heading w3-blue row"><h3>Head of ARCH RUET <!></h3></div>
      ...
      <div class="modal-dialog">
          ...
          <div class="modal-content">
              <div class="modal-header w3-blue">
                ...
                <div>
                    <p class="h4"><span class="fa fa-address-card-o"></span>&emsp;Dept. of Architecture (ARCH),<br>
                       &emsp;&emsp;Rajshahi University of Engineering & Technology (RUET),<br>
                       &emsp;&emsp;Kazla, Rajshahi-6204, Bangladesh.<br><br>
                       <span class="fa fa-fax"></span>&emsp;+88 (0721) 750105&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
                       <span class="fa fa-phone"></span>&emsp;+88 (721) 750742-3, 751320-1<br><br>
                       <span class="fa fa-internet-explorer"></span>&emsp;<a href="http://architecture.ruet.ac.bd/" target="_blank">http://architecture.ruet.ac.bd/</a>&emsp;&emsp;&emsp;
                       <span class="fa fa-envelope-o"></span>&emsp;<a href="https://mail.google.com/mail/u/0/#inbox?compose=new" target="_blank">architecture@ruet.ac.bd</a>
                   </p>
               </div>
              <div class="modal-footer w3-light-grey">
                  <button type="button" class="btn btn-primary" data-dismiss="modal">Close</button>
