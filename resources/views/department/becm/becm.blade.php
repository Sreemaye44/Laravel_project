...
<div class="container">
    <div class="row">
        <div class="col-lg-2 col-md-2 col-sm-6 col-xs-6">
            <ul class="w3-ul w3-border w3-bordered">
                ...
                <li class="w3-hover-shadow">
                    <a href="{{ route('becm.student') }}" class="w3-text-black btn">Current Students</a>
                </li>
                <li class="w3-hover-shadow">
                    <a href="{{ route('get.materials', ['filename' => 'Syllabus-BECM.pdf']) }}" target="_blank" class="w3-text-black btn">Syllabus</a>
                </li>
                <li class="w3-hover-shadow">
                    <a href="{{ route('get.materials', ['filename' => 'Routine-BECM.pdf']) }}" target="_blank" class="w3-text-black btn">Class Routine</a>
                </li>
                <li class="w3-hover-shadow">
                    <a href="{{ route('exam.list', ['department' => 'BECM']) }}" target="_blank" class="w3-text-black btn">Semester Result</a>
                </li>
                <li class="w3-hover-shadow">
                    <a href="{{ route('get.materials', ['filename' => 'CourseRegistration-BECM.pdf']) }}" target="_blank" class="w3-text-black btn">Course Registration</a>
                </li>
                <li class="w3-hover-shadow">
                    <a href="{{ route('get.materials', ['filename' => 'FormFillUp-BECM.pdf']) }}" target="_blank" class="w3-text-black btn">Exam Form Fill Up</a>
                </li>
            </ul>
        </div>
        ...
        <div class="col-lg-2 col-md-2 col-sm-6 col-xs-6 w3-right">
            <ul class="w3-ul w3-border w3-bordered">
                <li class="w3-indigo w3-xlarge w3-center">BECM RUET</li>
                <li class="w3-hover-shadow"><a href="#about" class="w3-text-black btn">About BECM RUET</a></li>
    ...
    <div class="row">
        <div class="col-md-7">
            <div id="about" class="panel panel-default w3-hover-shadow">
                <div class="panel-heading w3-blue row"><h3>About BECM RUET</h3></div>
                <div class="panel-body w3-light-grey row"  style="height: 200px; text-align: justify;">
                    <p class="w3-large" style="font-family: optima">
                        ...
                        in RUET started its journey in 2016.
                    </p>
        ...
        <div class="col-md-4 col-md-offset-1">
            <div class="panel panel-default w3-hover-shadow">
                <div class="panel-heading w3-blue row"><h3>Head of BECM RUET <!></h3></div>
      ...
      <div class="modal-dialog">
          ...
          <div class="modal-content">
              <div class="modal-header w3-blue">
                ...
                <div>
                    <p class="h4"><span class="fa fa-address-card-o"></span>&emsp;Dept. of Building Engineering & Construction Management (BECM),<br>
                       ...
                       <span class="fa fa-internet-explorer"></span>&emsp;<a href="http://becm.ruet.ac.bd/" target="_blank">http://becm.ruet.ac.bd/</a>&emsp;&emsp;&emsp;
                       <span class="fa fa-envelope-o"></span>&emsp;<a href="https://mail.google.com/mail/u/0/#inbox?compose=new" target="_blank">becm@ruet.ac.bd</a>
                   </p>
               </div>
              <div class="modal-footer w3-light-grey">
                  <button type="button" class="btn btn-primary" data-dismiss="modal">Close</button>
